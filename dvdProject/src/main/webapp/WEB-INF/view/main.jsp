    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a id="home" class="navbar-brand" href="/home.do">DVDProject</a> <a
                    class="navbar-brand" href="/dvdView.do">DVD 보기</a> <a
                    class="navbar-brand" href="/hello.do">DVD 검색</a> <a
                    class="navbar-brand" href="/userInfo.do">회원조회</a>
                <a class="navbar-brand" href="/dvdRoomInfo.do">DVD방 관리</a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
                <form class="navbar-form navbar-right">
                    ...
                    <button type="button" class="btn btn-success" data-toggle="modal"
                            data-target="#signUpFormModal">DVD방 회원가입
                    </button>
                    <button type="button" class="btn btn-danger"
                            onclick="location.href='/'">로그아웃
                    </button>
                </form>
            </div>
            <!--/.navbar-collapse -->
            ...
            <form class="form-horizontal" style="background-color: white">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="phoneInputText" name="phoneInputText" type="text"
                                   placeholder="010-1234-1234" class="form-control input-md"
                                   required="required">

                        </div>
                        <button id="phoneConfirm" name="phoneConfirm"
                                class="btn btn-success">중복확인
                        </button>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="emailInputText" name="emailInputText" type="text"
                                   placeholder="dvd@naver.com" class="form-control input-md"
                                   required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <button id="submitButton" name="submitButton"
                                    class="btn btn-success">Submit(제출)
                            </button>
                            <button id="cancleButton" type="button" class="btn btn-danger"
                                    data-dismiss="modal">Cancel(취소)
                            </button>
                        </div>
                    </div>
                </fieldset>
...
<script>
    ...
    $(document).ready(function () {
        ...
        function successFunction(responseData) {
            $("#document_body").html(responseData);
        }
        ;
