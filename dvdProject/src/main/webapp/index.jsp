	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<%--menu --%>
				<a class="navbar-brand" href="#">DVDProject</a>
				<a class="navbar-brand" href="#">DVD 등록</a>
				<a class="navbar-brand" href="#">DVD 검색</a>
				<a class="navbar-brand" href="#">회원조회</a>
				<a class="navbar-brand" href="#">DVD방 관리</a>
			</div>
